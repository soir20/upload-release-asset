...
Fork of [actions/upload-release-asset](https://github.com/actions/upload-release-asset) that uses Node 16 and updates the [deprecated](https://github.blog/changelog/2022-10-11-github-actions-deprecating-save-state-and-set-output-commands/) `set-output` command.
